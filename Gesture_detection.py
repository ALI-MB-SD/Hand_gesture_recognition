...
command_rules = [
    CommandRule("Three", "Swipe Right", "OPEN_APP", cooldown_ms=1200),
    ...
    CommandRule("OK", "Swipe Down", "CANCEL", cooldown_ms=1200),
    CommandRule("OK", "Swipe Up", "UNDO", cooldown_ms=1200),
]
...
while True:
    ...
    if detection_result.hand_landmarks:
        for hand_landmarks in detection_result.hand_landmarks:
            ...
            # 0.6–0.8 with no Unknown label // 0.3-0.5 with Unknown label
